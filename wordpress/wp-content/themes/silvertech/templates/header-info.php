...
$email_prefix = silvertech_get_mod( 'header_info_email_prefix', 'Email:' );
$phone_prefix = silvertech_get_mod( 'header_info_phone_prefix', 'Phone:' );
$address_prefix = silvertech_get_mod( 'header_info_address_prefix', 'Address:' );

$email = silvertech_get_mod( 'header_info_email' );
$phone = silvertech_get_mod( 'header_info_phone' );
$address = silvertech_get_mod( 'header_info_address' );
