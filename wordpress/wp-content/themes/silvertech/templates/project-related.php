...
if ( silvertech_get_mod( 'project_related', true ) )
    return;
...
$related_pre_title = silvertech_get_mod( 'related_pre_title', 'EXPLORE PROJECTS' );
$related_title = silvertech_get_mod( 'related_title', 'OUR RECENT PROJECTS' );
$project_related_query = silvertech_get_mod( 'project_related_query', 7 );
$project_related_column = silvertech_get_mod( 'project_related_column', 3 );
$project_related_item_spacing = silvertech_get_mod( 'project_related_item_spacing', 30 );
                    ...
                    <div class="project-image">
                        ...
                        <div class="text-wrap">
                            <h2 class="project-title">
                                <?php 
                                if ( silvertech_metabox( 'title' ) ) {
                                    echo silvertech_metabox( 'title' );
                                } else {
                                    the_title();
                                } ?>
                            </h2>
