...
function mae_iconpicker_register( $icons = array() ) {
	...
	$icons['silvertech'] = array(
		'name'          => 'silvertech',
		'label'         => esc_html__( 'Silvertech Icons', 'masterlayer' ),
		'labelIcon'     => 'qico-helmet',
		'prefix'        => 'qico-',
		'displayPrefix' => '',
		'url'           => MAE_URL . 'assets/css/silvertech-icons.css',
		'fetchJson'     => MAE_URL . 'assets/fonts/silvertech-icons/silvertech-icons.json',
		'ver'           => '1.0.0',
	);
