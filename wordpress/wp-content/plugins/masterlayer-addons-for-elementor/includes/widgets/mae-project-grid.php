...
class MAE_Project_Grid_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .projects-filter' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
    ...
    protected function render() {
        ...
        <div class="master-portfolio portfolio-grid <?php echo esc_attr($cls); ?>" <?php echo $data; ?>>
            <?php
            // Filter
            if ( $settings['filter'] ) { ?>
                <div class="projects-filter">                                
                    <div class="inner">
                        ...
                        if ( $settings['cat_slug'] ) {
                            ...
                            $term = get_term_by( 'slug', $settings['cat_slug'], 'project_category' ); 
