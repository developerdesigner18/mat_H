...
if ( ! class_exists( 'Masterlayer_Elementor_Addons' ) ) {
    ...
    final class Masterlayer_Elementor_Addons {
        ...
        public function register_frontend_styles() {
            ...
            wp_enqueue_style( 'silvertech-icons', MAE_URL . 'assets/css/silvertech-icons.css', array(), '1.0' );
        ...
        public function include_widgets() {
            ...
            require_once MAE_WIDGET_PATH . 'mae-template-carousel.php';
            $widgets_manager->register_widget_type( new \MasterlayerAddons\Widgets\MAE_Template_Carousel_Widget() );
