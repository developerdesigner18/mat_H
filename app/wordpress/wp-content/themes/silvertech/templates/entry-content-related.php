...
if ( ! is_single() || ! silvertech_get_mod( 'silvertech_blog_single_related', false ) )
    return;
...
if ( $query->have_posts() ) : ?>
    ...
    <div class="related-news">
        <h3 class="related-title"><?php echo esc_html( silvertech_get_mod( 'silvertech_blog_single_related_header' ) ); ?></h3>
