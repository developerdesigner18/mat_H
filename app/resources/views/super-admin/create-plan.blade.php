                    ...
                    <form action="/save-subscription-plan" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="max_file_upload_size" class="form-label">{{__('Maximum File Upload Size')}}  ({{__('kb')}})</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="file_space_limit" class="form-label">{{__('File Space Limit')}} ({{__('mb')}})</label>
