...
<head>
    ...
    <link id="pagestyle" href="{{PUBLIC_DIR}}/css/app.css?v=486" rel="stylesheet"/>
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0  fixed-left" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if(($selected_navigation ?? '') === 'saas-Coupons') active @endif "
                   href="/subscription-Coupons">
                    ...
                    <span class="nav-link-text ms-3">{{__('Coupons')}}</span>
                </a>
            </li>
