...
<style type="text/css">
    .inactivefeture {    pointer-events: none;
        opacity: 0.6;
    }
</style>
    ...
    <div class="collapse navbar-collapse  w-auto  d-print-none " id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            @if(empty($modules) || in_array('projects',$modules))
                <li class="nav-item @if(Auth::user()->projects == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('to_dos',$modules))
                ...
                <li class="nav-item @if(Auth::user()->to_dos == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('calendar',$modules))
                ...
                <li class="nav-item @if(Auth::user()->calendar == 0)inactivefeture @endif">
                    <a class="nav-link @if(($selected_navigation ?? '') === 'calendar') active @endif" href="/calendar">

                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                             class="feather feather-calender">
            ...
            @if(empty($modules) || in_array('brainstorm',$modules))
                <li class="nav-item @if(Auth::user()->brainstorm == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('investors',$modules))
                ...
                <li class="nav-item @if(Auth::user()->investors == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('business_model',$modules))
                ...
                <li class="nav-item @if(Auth::user()->business_model == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('business_model',$modules))
                ...
                <li class="nav-item @if(Auth::user()->startup_canvas == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('mckinsey',$modules))
                <li class="nav-item @if(Auth::user()->mckinsey == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('swot',$modules))
                <li class="nav-item @if(Auth::user()->swot == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('pest',$modules))
                <li class="nav-item @if(Auth::user()->pest == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('pestle',$modules))
                <li class="nav-item @if(Auth::user()->pestle == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('business_plan',$modules))
                ...
                <li class="nav-item @if(Auth::user()->business_plan == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('notes',$modules))
                ...
                <li class="nav-item @if(Auth::user()->notes == 0)inactivefeture @endif">
            ...
            @if(empty($modules) || in_array('documents',$modules))
                ...
                <li class="nav-item @if(Auth::user()->documents == 0)inactivefeture @endif">
            ...
            <li class="nav-item @if(Auth::user()->Users_tab == 0)inactivefeture @endif">
...
<!--   Core JS Files   -->
<script src="{{PUBLIC_DIR}}/js/app.js?v=98"></script>
