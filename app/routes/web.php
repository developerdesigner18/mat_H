...
Route::get("/subscription-Coupons", [SuperAdminController::class, "saasCoupons"]);
Route::post("/subscription-coupon",[SuperAdminController::class,"createSaasCoupon"]);
Route::get("/show-coupon",[SuperAdminController::class,"ShowCoupon"]);
Route::post("/clear-expired-coupon",[SuperAdminController::class,"ClearExpired"]);
...
Route::post("/user-post-by-superadmin", [SuperAdminController::class, "super_admin_userpost"]);
...
Route::post("payment-PayPal", [SubscribeController::class, "paymentPayPal"]);
Route::post("payment-barcode", [SubscribeController::class, "paymentbarcode"]);

//Route::get("/", [AuthController::class, "login"])->name("login");
Route::get("/login", [AuthController::class, "login"])->name("login");
Route::get("/signup", [AuthController::class, "signup"]);
Route::get("/subscribes", [AuthController::class, "Signup_subscribe"]);
...
Route::post("/updatepermition", [ProfileController::class, "updatepermition"]);
Route::post("/getstaffdata", [ProfileController::class, "getstaffdata"]);
...
Route::get("/renew_plan", [AuthController::class, "renew_plan"]);
