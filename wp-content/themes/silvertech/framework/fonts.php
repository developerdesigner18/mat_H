...
function silvertech_standard_fonts() {
	return array(
...
function silvertech_enqueue_google_font( $font ) {
	...
	// Subset
	$subset = silvertech_get_mod( 'google_font_subsets', 'latin' );
	...
	// Enqueue style
	wp_enqueue_style( 'silvertech-google-font-'. $handle, $url, false, false, 'all' );
}