...
if ( ! silvertech_get_mod( 'footer_widgets', true ) )
	return false;

// Get defaults from Customizer
$columns = silvertech_get_mod( 'footer_columns', '4' );
$gutter = silvertech_get_mod( 'footer_column_gutter', '30' );
...
<?php get_template_part( 'templates/single-section'); ?>
		
<footer id="footer" class="sticky-stopper" style="<?php echo silvertech_footer_bg(); ?>">	
