...
// Define vars
$logo_size = '';
$logo_cls = silvertech_get_mod( 'logo_extra' );
$logo_url = home_url( '/' );
$logo_title = get_bloginfo( 'name' );

$logo_img = silvertech_get_mod( 'custom_logo' );
$logo_width = silvertech_get_mod( 'logo_width' );
$logo_margin = silvertech_get_mod( 'logo_margin' );

// if page has custom logo
if ( is_page() ) {
	$custom_logo = silvertech_elementor( 'custom_logo' );
	if ( $custom_logo ) {
		if ( $custom_logo['url'] ) {
