...
class MAE_Accordions_Widget extends Widget_Base{
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'arrow_margin',
			[
				'label' => __( 'Arrow Spacing', 'masterlayer' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .master-accordions .arrow' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [ 
                    'arrow_position!' => 'none', 
                ]
