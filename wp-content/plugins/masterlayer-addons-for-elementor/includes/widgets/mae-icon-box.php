    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}}:hover .master-icon-box' => 'transform: translateY( {{SIZE}}{{UNIT}} );',
                ],
                50
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}} .master-icon svg' => 'height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}}:hover .master-icon-box .master-link' => 'color: {{VALUE}};',
                ],
                'condition' => [ 
                    'url_type' => 'link',
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}}:hover .master-icon-box .master-link .icon' => 'color: {{VALUE}};',
                ],
                'condition' => [ 
                    'link_icon_position!' => 'none', 
                    'url_type' => 'link',
    ...
    protected function render() {
        ...
        <div class="master-icon-box" <?php echo $data; ?>>       
            ...
            if ($settings['icon_type'] != 'none') {
                ...
                $icon2 = sprintf('<div class="icon-wrap2">%1$s</div>',
                    $icon_html,
                    $settings['title']
                );
            }
