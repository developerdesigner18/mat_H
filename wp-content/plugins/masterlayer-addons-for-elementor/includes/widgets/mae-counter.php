...
class MAE_Counter_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' 	=> 'style-01',
				'options' 	=> [
					'style-01'  => __( 'Number Top', 'masterlayer' ),
					'style-02'  => __( 'Number Bottom', 'masterlayer' ),
				]
			]
		);
		...
		$this->add_responsive_control(
			'desc_bottom_spacing',
			[
				'label' => __( 'Desc: Bottom Spacing', 'masterlayer' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
				...
				'selectors' => [
					'{{WRAPPER}} .desc' => 'padding-bottom: calc({{SIZE}}{{UNIT}});',
				],
				'condition' => [
					'style' => 'style-02',
				]
	...
	protected function render() {
		...
		?>
		<?php if ( $settings['style'] === 'style-01' ) {  ?>
			<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			    ...
			    <span class="desc"><?php echo $settings['desc']; ?></span>
		    </div>
		<?php } ?>
	    <?php
	}
