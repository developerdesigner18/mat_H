				...
				<li class="clearfix" style="<?php echo esc_attr( $item_css ); ?>">
                    ...
                    <div class="thumb <?php echo esc_attr( $thumb_style ); ?>" style="<?php echo esc_attr( $thumb_css ); ?>">
                        <?php
                            ...
                            $size = 'silvertech-post-widget';

                            if ( has_post_thumbnail() ) {
                                the_post_thumbnail( $size );
                            } elseif ( get_post_format() == 'gallery' ) {
                                $images = silvertech_metabox( 'gallery_images', "type=image&size=$size" );
                    ...
                    if ( ! empty( $title_length ) ) {
                        //$title = silvertech_trim_words( $title, $title_length );
                    }
...
add_action( 'widgets_init', 'register_silvertech_recent_news' );

// Register widget
function register_silvertech_recent_news() {
